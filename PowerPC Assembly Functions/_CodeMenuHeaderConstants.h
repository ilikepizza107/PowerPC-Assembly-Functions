...
static const int UNUSED_SPACE_FROM_RESET_LINE_STACK_SHRINK_0 = RESET_LINES_STACK_LOC + 4 * MAX_SUBPAGE_DEPTH + 8; //4, UNUSED!
static const int UNUSED_SPACE_FROM_RESET_LINE_STACK_SHRINK_1 = UNUSED_SPACE_FROM_RESET_LINE_STACK_SHRINK_0 + 4; //4, UNUSED!
static const int UNUSED_SPACE_FROM_RESET_LINE_STACK_SHRINK_2 = UNUSED_SPACE_FROM_RESET_LINE_STACK_SHRINK_1 + 4; //4, UNUSED!
static const int ALT_STAGE_BEHAVIOR_LOC = UNUSED_SPACE_FROM_RESET_LINE_STACK_SHRINK_2 + 4; // 4

static const int CHARACTER_SWITCHER_ARRAY_LOC = ALT_STAGE_BEHAVIOR_LOC + 0x4; //0x10
...
static const int PSCC_CALLBACK_TABLE_LOC = JUMPSQUAT_OVERRIDE_MAX_LOC + 0x4; // 0x4

static const int DRAW_SETTINGS_BUFFER_LOC = PSCC_CALLBACK_TABLE_LOC + 4; //0x200
...
#define GRAY_YELLOW   0xB0B020FF
#define GRAY_TEAL     0x5880B0FF
#define GRAY_BLUE     0x3858B0FF
...
struct __LineColorsTable
{
	enum COLORS_ENUM
	{
		...
		COLOR_LOCKED_NORMAL,
		COLOR_LOCKED_HIGHL,
		COLOR_LOCKED_CH_NORMAL,
		COLOR_LOCKED_CH_HIGHL,
		COLOR_COMMENT,
		__COLOR_COUNT
	};
	...
	std::array<std::string, __COLOR_COUNT> COLOR_NAMES_ARR;
	...
	__LineColorsTable()
	{
		...
		COLORS_ARR[COLORS_ENUM::COLOR_LOCKED_NORMAL]         = GRAY;
		COLORS_ARR[COLORS_ENUM::COLOR_LOCKED_HIGHL]          = GRAY_YELLOW;
		COLORS_ARR[COLORS_ENUM::COLOR_LOCKED_CH_NORMAL]      = GRAY_TEAL;
		COLORS_ARR[COLORS_ENUM::COLOR_LOCKED_CH_HIGHL]       = GRAY_BLUE;
		COLORS_ARR[COLORS_ENUM::COLOR_COMMENT]               = GREEN;

		COLOR_NAMES_ARR[COLORS_ENUM::COLOR_NORMAL]           = "NORMAL";
		COLOR_NAMES_ARR[COLORS_ENUM::COLOR_HIGHL]            = "SELECTED";
		COLOR_NAMES_ARR[COLORS_ENUM::COLOR_CH_NORMAL]        = "CHANGED";
		COLOR_NAMES_ARR[COLORS_ENUM::COLOR_CH_HIGHL]         = "CHANGED_SELECTED";
		COLOR_NAMES_ARR[COLORS_ENUM::COLOR_LOCKED_NORMAL]    = "LOCKED";
		COLOR_NAMES_ARR[COLORS_ENUM::COLOR_LOCKED_HIGHL]     = "LOCKED_SELECTED";
		COLOR_NAMES_ARR[COLORS_ENUM::COLOR_LOCKED_CH_NORMAL] = "LOCKED_CHANGED";
		COLOR_NAMES_ARR[COLORS_ENUM::COLOR_LOCKED_CH_HIGHL]  = "LOCKED_CHANGED_SELECTED";
		COLOR_NAMES_ARR[COLORS_ENUM::COLOR_COMMENT]          = "COMMENT";
	}
...
static const u8 CHANGED_AND_HIGHLIGHTED_LINE_COLOR_OFFSET = LINE_COLOR_TABLE.offset(LINE_COLOR_TABLE.COLOR_CH_HIGHL);
static const u8 LOCKED_NORMAL_LINE_COLOR_OFFSET = LINE_COLOR_TABLE.offset(LINE_COLOR_TABLE.COLOR_LOCKED_NORMAL);
static const u8 LOCKED_HIGHLIGHTED_LINE_COLOR_OFFSET = LINE_COLOR_TABLE.offset(LINE_COLOR_TABLE.COLOR_LOCKED_HIGHL);
static const u8 LOCKED_CHANGED_LINE_COLOR_OFFSET = LINE_COLOR_TABLE.offset(LINE_COLOR_TABLE.COLOR_LOCKED_CH_NORMAL);
static const u8 LOCKED_CHANGED_AND_HIGHLIGHTED_LINE_COLOR_OFFSET = LINE_COLOR_TABLE.offset(LINE_COLOR_TABLE.COLOR_LOCKED_CH_HIGHL);
static const u8 COMMENT_LINE_COLOR_OFFSET = LINE_COLOR_TABLE.offset(LINE_COLOR_TABLE.COLOR_COMMENT);
