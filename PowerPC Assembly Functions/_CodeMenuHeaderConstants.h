...
private:
	constexpr std::array<int, __COLOR_COUNT> getArray()
	{
		...
		result[COLORS::COLOR_HDN_NORMAL]    = BLACK;
		result[COLORS::COLOR_HDN_HIGHL]     = GRAY;
		result[COLORS::COLOR_CH_HDN_NORMAL] = TEAL;
		result[COLORS::COLOR_CH_HDN_HIGHL]  = BLUE;
...
static const u8 HIDDEN_LINE_COLOR_OFFSET = LINE_COLOR_TABLE.offset(LINE_COLOR_TABLE.COLOR_HDN_NORMAL);
static const u8 HIGHLIGHTED_HIDDEN_LINE_COLOR_OFFSET = LINE_COLOR_TABLE.offset(LINE_COLOR_TABLE.COLOR_HDN_HIGHL);
static const u8 CHANGED_HIDDEN_LINE_COLOR_OFFSET = LINE_COLOR_TABLE.offset(LINE_COLOR_TABLE.COLOR_CH_HDN_NORMAL);
static const u8 CHANGED_HIGHLIGHTED_HIDDEN_LINE_COLOR_OFFSET = LINE_COLOR_TABLE.offset(LINE_COLOR_TABLE.COLOR_CH_HDN_HIGHL);
