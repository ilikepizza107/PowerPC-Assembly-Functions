...
void SetHitStart()
{
	//r30 = module ptr
	//r31 = damage log
	ASMStart(0x808761e8, "Set Hit Start");
...
void AddToSDIBuffer()
{
	...
	//r30 = module ptr
	//can use r12, r3
	ASMStart(0x80876c84, "Add to SDI Buffer");
	SaveRegisters();
...
void AddToASDIBuffer()
{
	...
	//r31 = module ptr
	//use f3, r3, r12
	ASMStart(0x80876fec, "Add To ASDI Buffer");
	SaveRegisters();
...
{
	//r29 = module ptr
	ASMStart(0x80877b48, "Set Trajectory Buffers");
