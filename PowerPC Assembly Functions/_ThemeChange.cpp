...
void menuMainChange()
{
	...
	if (THEME_SETTING_INDEX != -1)
	{
		...
		ASMStart(0x806cbfa0, "Theme Changer (menumain) " + codeVersion +" [QuickLava]"); // Hooks the fifth instruction of "start/[muMenuMain]/mu_main.o".
...
void selCharChange()
{
	...
	if (THEME_SETTING_INDEX != -1)
	{
		...
		ASMStart(0x806c8730, "Theme Changer (selchar) " + codeVersion + " [QuickLava]"); // Hooks "process/[scEnding]/sc_ending.o", credit to SammiHusky for the hook!
...
void selMapChange()
{
	...
	if (THEME_SETTING_INDEX != -1)
	{
		...
		ASMStart(0x806c8d88, "Theme Changer (selmap) " + codeVersion + " [QuickLava]"); // Hooks the fifth instruction of "start/[scSelStage]/sc_sel_stage.o".
...
void selEventChange()
{
	...
	if (THEME_SETTING_INDEX != -1)
	{
		...
		ASMStart(0x806c44b4, "Theme Changer (selevent) " + codeVersion + " [QuickLava]"); // Hooks the fifth instruction of "start/[scSelEvent]/sc_sel_event.o".
...
void titleChange()
{
	...
	if (THEME_SETTING_INDEX != -1)
	{
		...
		ASMStart(0x806ca14c, "Theme Changer (title) " + codeVersion + " [QuickLava]"); // Hooks " next/[adList<Ul,42>]/sc_fig_get_demo.o".
